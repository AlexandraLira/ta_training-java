...
матрицы. При таком умножении элементы в **i-й** строке матрицы *A* умножаются на соответствующие элементы в **j-м**
столбце матрицы *B*, а сумма полученных значений сохраняется в **ij-й** элемент результирующей матрицы.
