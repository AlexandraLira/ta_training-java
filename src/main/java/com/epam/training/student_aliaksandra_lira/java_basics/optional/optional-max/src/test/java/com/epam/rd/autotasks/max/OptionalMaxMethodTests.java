...
class OptionalMaxMethodTests {

    @Test
    @DisplayName("For an empty array returns empty result")
    void testEmptyArray() {
        OptionalInt result = OptionalMaxMethod.max(new int[]{});
    ...
    void testNullArray() {
        OptionalInt result = OptionalMaxMethod.max(null);
        assertTrue(result.isEmpty());
    }
    ...
    void testReturnArraysSingleValue() {
        ...
        OptionalInt result = OptionalMaxMethod.max(values);
